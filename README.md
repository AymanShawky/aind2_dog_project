...
5. Obtain the necessary Python packages, and switch Keras backend to Tensorflow.  
	...
	For __Windows__:
	```
		conda env create -f C:\Users\shawkya\Desktop\dog-project-master\requirements\aind-dog-windows.yml
		activate aind-dog
...
6. Open the notebook and follow the instructions.
	...
	```
		jupyter notebook C:\Users\shawkya\Desktop\dog-project-master\dog_app.ipynb
	```
